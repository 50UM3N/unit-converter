...
export default memo(function Area() {
  ...
  const convert = (data) => {
    ...
    if (unit1 === "Square kilometer" && unit2 === "Square meter")
      ...
      data = data * 0.0015625;
    else if (unit1 === "Acre" && unit2 === "Square yard") data = data * 4840;
    else if (unit1 === "Acre" && unit2 === "Square foot") data = data * 43560;
    else if (unit1 === "Acre" && unit2 === "Square inch") data = data * 6.273e6;
    else if (unit1 === "Acre" && unit2 === "Hectare") data = data * 0.404686;
