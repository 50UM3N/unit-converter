...
export default memo(function Time() {
  ...
  const convert = (data) => {
    ...
    if (unit1 === "Nanosecond" && unit2 === "Microsecond") data = data * 0.001;
    else if (unit1 === "Nanosecond" && unit2 === "Millisecond")
      data = data * 1e-6;
    else if (unit1 === "Nanosecond" && unit2 === "Second") data = data * 1e-9;
      ...
      data = data * 0.001;
    else if (unit1 === "Microsecond" && unit2 === "Second") data = data * 1e-6;
      ...
      data = data * 1000;
    else if (unit1 === "Millisecond" && unit2 === "Second") data = data * 0.001;
      ...
      data = data * 3.171e-13;
    else if (unit1 === "Second" && unit2 === "Nanosecond") data = data * 1e9;
    else if (unit1 === "Second" && unit2 === "Microsecond") data = data * 1e6;
    else if (unit1 === "Second" && unit2 === "Millisecond") data = data * 1000;
    else if (unit1 === "Second" && unit2 === "Minute") data = data * 0.0166667;
    else if (unit1 === "Second" && unit2 === "Hour") data = data * 0.000277778;
    else if (unit1 === "Second" && unit2 === "Day") data = data * 1.1574e-5;
    else if (unit1 === "Second" && unit2 === "Week") data = data * 1.6534e-6;
    else if (unit1 === "Second" && unit2 === "Month") data = data * 3.8052e-7;
    else if (unit1 === "Second" && unit2 === "Calendar year")
      data = data * 3.171e-8;
    else if (unit1 === "Second" && unit2 === "Decade") data = data * 3.171e-9;
    else if (unit1 === "Second" && unit2 === "Century") data = data * 3.171e-10;
    else if (unit1 === "Minute" && unit2 === "Nanosecond") data = data * 6e10;
    else if (unit1 === "Minute" && unit2 === "Microsecond") data = data * 6e7;
    else if (unit1 === "Minute" && unit2 === "Millisecond") data = data * 60000;
    else if (unit1 === "Minute" && unit2 === "Second") data = data * 60;
    else if (unit1 === "Minute" && unit2 === "Hour") data = data * 0.0166667;
    else if (unit1 === "Minute" && unit2 === "Day") data = data * 0.000694444;
    else if (unit1 === "Minute" && unit2 === "Week") data = data * 9.9206e-5;
    else if (unit1 === "Minute" && unit2 === "Month") data = data * 2.2831e-5;
    else if (unit1 === "Minute" && unit2 === "Calendar year")
      data = data * 1.9026e-6;
    else if (unit1 === "Minute" && unit2 === "Decade") data = data * 1.9026e-7;
    else if (unit1 === "Minute" && unit2 === "Century") data = data * 1.9026e-8;
    else if (unit1 === "Hour" && unit2 === "Nanosecond") data = data * 3.6e12;
    else if (unit1 === "Hour" && unit2 === "Microsecond") data = data * 3.6e9;
    else if (unit1 === "Hour" && unit2 === "Millisecond") data = data * 3.6e6;
    ...
    else if (unit1 === "Hour" && unit2 === "Month") data = data * 0.00136986;
    else if (unit1 === "Hour" && unit2 === "Calendar year")
      data = data * 0.000114155;
    else if (unit1 === "Hour" && unit2 === "Decade") data = data * 1.1416e-5;
    else if (unit1 === "Hour" && unit2 === "Century") data = data * 1.1416e-6;
    else if (unit1 === "Day" && unit2 === "Nanosecond") data = data * 8.64e13;
    else if (unit1 === "Day" && unit2 === "Microsecond") data = data * 8.64e10;
    else if (unit1 === "Day" && unit2 === "Millisecond") data = data * 8.64e7;
    ...
    else if (unit1 === "Day" && unit2 === "Decade") data = data * 0.000273973;
    else if (unit1 === "Day" && unit2 === "Century") data = data * 2.7397e-5;
    else if (unit1 === "Week" && unit2 === "Nanosecond") data = data * 6.048e14;
    else if (unit1 === "Week" && unit2 === "Microsecond")
      data = data * 6.048e11;
    else if (unit1 === "Week" && unit2 === "Millisecond") data = data * 6.048e8;
      ...
      data = data * 0.0191781;
    else if (unit1 === "Week" && unit2 === "Decade") data = data * 0.00191781;
    else if (unit1 === "Week" && unit2 === "Century") data = data * 0.000191781;
      ...
      data = data * 0.0833334;
    else if (unit1 === "Month" && unit2 === "Decade") data = data * 0.00833334;
      ...
      data = data * 525600;
    else if (unit1 === "Calendar year" && unit2 === "Hour") data = data * 8760;
    else if (unit1 === "Calendar year" && unit2 === "Day") data = data * 365;
    else if (unit1 === "Calendar year" && unit2 === "Week")
      data = data * 52.1429;
    else if (unit1 === "Calendar year" && unit2 === "Month") data = data * 12;
    else if (unit1 === "Calendar year" && unit2 === "Decade") data = data * 0.1;
      ...
      data = data * 3.154e11;
    else if (unit1 === "Decade" && unit2 === "Second") data = data * 3.154e8;
    else if (unit1 === "Decade" && unit2 === "Minute") data = data * 5.256e6;
    ...
    else if (unit1 === "Decade" && unit2 === "Calendar year") data = data * 10;
      ...
      data = data * 3.154e12;
    else if (unit1 === "Century" && unit2 === "Second") data = data * 3.154e9;
    else if (unit1 === "Century" && unit2 === "Minute") data = data * 5.256e7;
